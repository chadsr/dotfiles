...
declare -a symlink_paths_tuples=(
    ...
    "${git_submodule_path}/sweet-theme/index.theme ${base_path}/gtk/.themes/sweet-theme/index.theme"
    "${git_submodule_path}/sweet-theme/gtk-2.0 ${base_path}/gtk/.themes/sweet-theme/gtk-2.0"
    "${git_submodule_path}/sweet-theme/gtk-3.0 ${base_path}/gtk/.themes/sweet-theme/gtk-3.0"
    "${git_submodule_path}/sweet-theme/gtk-4.0 ${base_path}/gtk/.themes/sweet-theme/gtk-4.0"
    "${git_submodule_path}/sweet-theme/kde/Kvantum/Sweet/Sweet.kvconfig ${base_path}/qt/.config/Kvantum/Sweet.kvconfig"
    "${git_submodule_path}/sweet-theme/kde/Kvantum/Sweet/Sweet.svg ${base_path}/qt/.config/Kvantum/Sweet.svg"
