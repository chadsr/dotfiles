...
hl.bind(mainMod .. " + Period", hl.dsp.exec_cmd("emote")) -- launch emoji selector
...
hl.bind(mainMod .. " + SHIFT + Left", hl.dsp.window.move({ direction = "l" }), { repeating = true, description = "Move activewindow to the left" })
hl.bind(mainMod .. " + SHIFT + Right", hl.dsp.window.move({ direction = "r" }), { repeating = true, description = "Move activewindow to the right" })
hl.bind(mainMod .. " + SHIFT + Up", hl.dsp.window.move({ direction = "u" }), { repeating = true, description = "Move activewindow up" })
hl.bind(mainMod .. " + SHIFT + Down", hl.dsp.window.move({ direction = "d" }), { repeating = true, description = "Move activewindow down" })
