...
hl.bind(mainMod .. " + grave",          hl.dsp.exec_cmd("hyprctl dispatch hyprexpo:expo toggle"))                       -- can be: toggle, off/disable or on/enable
...
hl.bind(mainMod .. " + SHIFT + Left",  hl.dsp.exec_cmd(moveactivewindow .. " -30 0 || hyprctl dispatch movewindow l"), { repeating = true, description = "Move activewindow to the left" })
hl.bind(mainMod .. " + SHIFT + Right", hl.dsp.exec_cmd(moveactivewindow .. " 30 0 || hyprctl dispatch movewindow r"),  { repeating = true, description = "Move activewindow to the right" })
hl.bind(mainMod .. " + SHIFT + Up",    hl.dsp.exec_cmd(moveactivewindow .. " 0 -30 || hyprctl dispatch movewindow u"),  { repeating = true, description = "Move activewindow up" })
hl.bind(mainMod .. " + SHIFT + Down",  hl.dsp.exec_cmd(moveactivewindow .. " 0 30 || hyprctl dispatch movewindow d"),   { repeating = true, description = "Move activewindow down" })
