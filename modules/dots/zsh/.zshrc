...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
  # Source the first plugin path that exists (portable: Arch, then the Nix
  # home-manager profile). # shellcheck source=/dev/null
  ...
  _zsrc /usr/share/zsh/plugins/zsh-autosuggestions/zsh-autosuggestions.plugin.zsh \
    "$HOME/.nix-profile/share/zsh-autosuggestions/zsh-autosuggestions.zsh"
  # shellcheck source=/dev/null
  _zsrc /usr/share/zsh/plugins/zsh-autocomplete/zsh-autocomplete.plugin.zsh \
    "$HOME/.nix-profile/share/zsh-autocomplete/zsh-autocomplete.plugin.zsh"

  # zsh-syntax-highlighting must be loaded last
  # shellcheck source=/dev/null
  _zsrc /usr/share/zsh/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh \
